"""
@File: ResNet18 Training on balanced DeepInsight Dataset(InfoGAN)
@Author: Puxin
...
dataset_path = "deepinsight-infogan-balanced/Balanced_infoGAN"
...
for epoch in range(num_epochs):
    ...
    if test_result[0] < 0.2 or test_result[1] > 0.87:
        torch.save(model.state_dict(), f"ResNet18_DI_infob_epoch{epoch+1}.pth")
        torch.save(model.state_dict(), f"ResNet18_DI_infob_epoch{epoch+1}.pt")
